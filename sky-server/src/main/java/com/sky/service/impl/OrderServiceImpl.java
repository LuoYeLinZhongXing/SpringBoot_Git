...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderSubmitVO submitOrder(OrdersSubmitDTO ordersSubmitDTO) {
        ...
        ShoppingCart build = ShoppingCart.builder()
                .userId(currentId)
                .build();
        List<ShoppingCart> shoppingCartList = shoppingCartMapper.list(build);
        ...
        shoppingCartList.forEach(shoppingCart -> {
            ...
            BeanUtils.copyProperties(shoppingCart,orderDetail);//拷贝
        ...
        //封装OrderSubmitVO并返回
        OrderSubmitVO build1 = OrderSubmitVO.builder()
                .id(orders.getId())
    ...
    public void rejection(OrdersRejectionDTO ordersRejectionDTO) throws Exception {
        Orders byId = orderMapper.getById(ordersRejectionDTO.getId());

        if(byId == null || byId.getStatus() != Orders.TO_BE_CONFIRMED)
            throw new OrderBusinessException(MessageConstant.ORDER_NOT_FOUND);

        //支付状态
        Integer payStatus = byId.getPayStatus();
